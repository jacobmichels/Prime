...
namespace server.Controllers
{
    ...
    public class Users : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutUser(int id, DatabaseUser databaseUser)
        {
            if (id != databaseUser.Id)
            {
                return BadRequest();
            }
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<DatabaseUser>> PostUser(DatabaseUser databaseUser)
        {
            _context.Users.Add(databaseUser);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetUser", new { id = databaseUser.Id }, databaseUser);
        }
